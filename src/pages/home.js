...
// If height is less than 750 only then do we not fit everything on the screen? Or should we scale it down?
  render() {
    ...
    return (
      <div>
        {/*<div className="home-half-height motto">*/}
          {/*<div>Quality conversations</div>*/}
          {/*<div>Connect.Discuss.Enjoy</div>*/}
        {/*</div>*/}
        {/*<div className="home-half-height background-blue"></div>*/}
        {/*<div className="footer">*/}
          {/*/!*<span className="footer-item"><Link to="/about">About</Link></span>*!/*/}
          ...
          {/*<div style={{ backgroundImage: 'linear-gradient(180deg, #4fadff 10%, #0074d9)'}}>*/}
            <div style={{ ...styles.section1 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%', width: sectionWidthThird}}>
                <div style={{...styles.motto}} className={`fade-in-motto ${didMount && 'visible'}`}>Quality conversations</div>
